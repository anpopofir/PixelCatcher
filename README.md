...
1. Ves a la pestanya de [Releases](../../releases) i descarrega l'última versió de `PixelCatcher.exe`.
...
**Requisits previs:**
Assegura't de tenir Python instal·lat i afegit al teu `PATH`.

**1. Clonar el repositori i preparar l'entorn:**
```bash
git clone [https://github.com/anpopofir/PixelCatcher.git](https://github.com/anpopofir/PixelCatcher.git)
cd PixelCatcher
python -m pip install pillow pyautogui pyinstaller
